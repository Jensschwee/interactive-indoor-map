...
namespace Website.Logic.Domain
{
    public class BuildingSetup
    {
        ...
        {
            Ø20_508a_0 = new Room("Ø20-508a-0", new Corners(
            ...
            Ø22_508_0 = new Room("Ø22-508-0", new Corners(
            ...
            Ø22_604_0 = new Room("Ø22-604-0", new Corners(
            ...
            Ø20_604_0 = new Room("Ø20_604_0", new Corners(
